...
class Comeoffice extends CI_Controller {
	public $menu = 'menu2';
	public $nav = array('navTitle' => '오시는 길', 'navLink1' => '/home_admin/comeoffice/modifyset', 'navTitle2' => '', 'navLink2' => '');
...
//		$result['info'] = $info[0];
		...
		// layout 을 적용
		$this->layout->setLayout("/admin/layouts/layout");
		$this->layout->view('/admin/content/defaultset/comeoffice_modify', $result, true);
	}

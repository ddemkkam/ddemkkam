...
class Media extends CI_Controller
{
	...
	public function __construct()
	{
		...
		$this->load->model('/home_admin/Media_model', 'Media_model');
	...
	public function index()
	{
		...
		$result['branchListDataTotal'] = $this->Media_model->getMediaListTotal($data);
		$result['branchListData'] = $this->Media_model->getMediaList($data);
		$result['pagenation'] = $this->pagenation->pagenationHtml2('/home_admin/media', count($result['branchListDataTotal']), $data['page'], $data['page_num'], $data['list_num']);
		...
		$this->layout->view('/admin/content/media/media', $result, true);
	}

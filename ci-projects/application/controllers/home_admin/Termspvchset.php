...
class Termspvchset extends CI_Controller
{
	public $menu = 'menu1';
	public $nav = array('navTitle' => '개인정보 처리방침 설정', 'navLink1' => '/home_admin/termsSet', 'navTitle2' => '', 'navLink2' => '');
	...
	*/
	...
	public function modify($B_BRANCH = null, $B_LAN = null, $SEQ = null)
	{
		...
		$this->layout->setLayout("/admin/layouts/layout");
		$this->layout->view('/admin/content/tremsset/public_regist', $result, true);
	}
	...
	public function saveTermsSet()
	{
		...
		if ( $res ) {
			...
			echo "<script>alert('저장 하였습니다.'); location.replace('/home_admin/termspvchset/modify/".$data['T_BRANCH']."/".$data['T_LAN']."');</script>";
		} else {

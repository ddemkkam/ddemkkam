...
<div class="row">
	<div class="col-xs-10">
		<div class="box">
			<div class="box-body">
				<form id="event_frm" action="/home_admin/mainimg/save_img_set" method="POST" enctype="multipart/form-data">
						...
						<?for ( $i = 0; $i < 10; $i++ ) {?>
							<li style='background-color: #ffffff; clear: both; height: 260px; border: 1px solid #F5F5F5;'>
								<div class="col-xs-12" style="padding-left: 0px;">
									...
									<div class="col-xs-4">
										<iframe
											src="/fileUpload/uploadView?id=mainimg&cnt=1&viewId=viewId<?=$i?>"
											frameborder="0"
...
<script type="text/javascript">
	...
	function file_upload_open(){
		window.open('/fileUpload/uploadView?id=mainimg&cnt=1&viewId=viewId', '이미지 업로드', 'width=700px,height=250px,scrollbars=yes');
	}

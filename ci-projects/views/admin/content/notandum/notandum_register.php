...
<div class="row">
	<div class="col-xs-10">
		<div class="box">
			<div class="box-body">
				<form id="board_frm" action="/home_admin/notandum/save" method="POST" enctype="multipart/form-data">
					...
					<table id="division_table" class="table table-bordered">
						...
						<tr>
							<th class="active text-center">시술전 & 시술후</th>
							<td>
								<select name="N_TYPE" id="N_TYPE" class="form-control" >
									<option value="B" <?=isset($info['N_TYPE']) && $info['N_TYPE'] === 'B' ? 'selected' : ''?> >시술전</option>
									<option value="A" <?=isset($info['N_TYPE']) && $info['N_TYPE'] === 'A' ? 'selected' : ''?> >시술후</option>
								</select>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<th class="active text-center">관련시술</th>
							<td>
								<input type="text" class="form-control" name="N_SUB_TITLE" id="N_SUB_TITLE" value="<?=isset($info['N_SUB_TITLE']) ? $info['N_SUB_TITLE'] : ''?>">
							</td>
						</tr>

...
<aside class="main-sidebar">
	...
	<section class="sidebar">
		...
		<ul class="sidebar-menu" data-widget="tree">
			<li class="<?=strpos($_SERVER['REQUEST_URI'], '/home_admin/rankset/') !== false ? 'active menu-open' : ''?>">
				<a href="/home_admin/rankset/modifyrank/<?=isset($BASEBRANCH) ? $BASEBRANCH.'/' : ''?><?=isset($BASELAN) ? $BASELAN.'/' : ''?>">
					<i class="fa fa-circle-o <?=strpos($_SERVER['REQUEST_URI'], '/home_admin/rankset') !== false ? 'text-aqua' : ''?>"></i>
					<span>검색순위 설정</span>
				</a>
			</li>
			...
			<?/*
			<li class="<?=strpos($_SERVER['REQUEST_URI'], '/home_admin/media') !== false ? 'active menu-open' : ''?>">
				<a href="/home_admin/media/">
					<i class="fa fa-circle-o <?=strpos($_SERVER['REQUEST_URI'], '/home_admin/media') !== false ? 'text-aqua' : ''?>"></i>
					<span>방송/언론보도</span>
				</a>
			</li>

			<li class="<?=strpos($_SERVER['REQUEST_URI'], '/home_admin/beforeafter') !== false ? 'active menu-open' : ''?>">
				<a href="/home_admin/beforeafter/">
					<i class="fa fa-circle-o <?=strpos($_SERVER['REQUEST_URI'], '/home_admin/beforeafter') !== false ? 'text-aqua' : ''?>"></i>
					<span>전후사진</span>
				</a>
			</li>
			*/?>
